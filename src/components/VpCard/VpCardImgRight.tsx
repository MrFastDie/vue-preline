...
export const VpCardImgRight = defineComponent({
    ...
    setup(props, {slots}) {
        ...
        return () => (
            <div class={classList}>
                <div
                    class="flex-shrink-0 relative w-full rounded-t-xl overflow-hidden pt-[40%] sm:rounded-l-xl sm:max-w-[15rem] md:rounded-tr-none md:max-w-xs sm:order-last">
